...
export const changelogLocales = {
  ...
  "ka": {
    "2.0.0": {
      "date": "2026-04-01",
      "changes": [
        "გზამკვლევები: დაემატა ნაბიჯ-ნაბიჯ გზამკვლევები ყველა ქიმიურ ხელსაწყოსა და ელემენტის ყველა გვერდზე",
        "ახალი ხელსაწყო: დაემატა ინტერაქტიული ვირტუალური ლაბორატორია ქიმიის პრაქტიკული შესწავლისთვის",
        "ხელსაწყოების გასუფთავება: წაიშალა ერთი ზედმეტი ძველი ხელსაწყო სამუშაო სივრცის გასამარტივებლად",
        "საიმედოობა: ვერსიაზე დაფუძნებული იძულებითი განახლება უზრუნველყოფს, რომ ყველა მომხმარებელი უახლეს ფუნქციებსა და თარგმანებს ტვირთავდეს",
        "ახალი: ელემენტის ინფორმაციის გადამრთველი (EIT) — მთელი ცხრილის თვისებების ვიზუალიზაცია ფერისა და ფილტრის რეჟიმებით",
        "რედიზაინი: ქიმიის ხელსაწყოების მთავარი გვერდი თავიდან აიწყო — სუფთა ბარათები, მკაფიო იერარქია და სწრაფი ნავიგაცია",
        "ლოკალიზაცია: მრავალენოვანი მხარდაჭერის დიდი გაფართოება ინტერფეისში, იონებში, სამუშაო ფურცელში, პარამეტრებსა და ძიებაში",
        "მონაცემები: დაემატა უფრო მდიდარი ინფორმაცია ელემენტებზე, გაუმჯობესდა ისტორიული შენიშვნები და ინფორმაციული შრეები",
        "ძიება: დაემატა ცალკე ძიების ღილაკი და გაუმჯობესდა ელემენტების ლოკალიზებული სახელებით ძიება",
        "დახვეწა: გასწორდა განლაგების, თარგმანისა და ურთიერთქმედების მრავალი შეცდომა მთელ საიტზე"
      ]
    },
    "1.3.0": {
      "date": "2026-03-07",
      "changes": [
        "ახალი: ელემენტის ინფორმაციის გადამრთველი (EIT) — ნებისმიერი რიცხვითი თვისების ვიზუალიზაცია მთელ პერიოდულ ცხრილზე ფერის ან ფილტრის რეჟიმით",
        "ახალი: დააჭირეთ თვისების მნიშვნელობას ელემენტის ფანჯარაში ერთეულების გადასართავად (მაგ. °C ↔ °F ↔ K)",
        "მონაცემები: ელემენტების მონაცემების სრული შემოწმება და სიზუსტის შესწორებები",
        "წარმადობა: 3D ატომის რენდერერი ოპტიმიზდა — ბირთვის შიდა ნაწილის გამოტოვება, გეომეტრიის ქეშირება, ვექტორების ხელახალი გამოყენება",
        "წარმადობა: EIT სლაიდერი იყენებს DOM-ის სწრაფ განახლებას შეფერხების გარეშე ურთიერთქმედებისთვის",
        "UI: ორბიტების მონიშვნა კურსორის მიტანისას 3D ატომის ხედში",
        "გასუფთავება: წაიშალა 1.16 MB ზედმეტი ფაილი, კოდი გამარტივდა"
      ]
    },
    "1.2.0": {
      "date": "2026-03-01",
      "changes": [
        "ახალი პარამეტრების გვერდი ანიმაციის სიჩქარის კონტროლით და პაუზით",
        "გამარტივებული ნავიგაციის ზოლი — ბმულები გადავიდა პარამეტრების მოდულურ ბარათებში",
        "წინადადებების ველი სწრაფი უკუკავშირის ღილაკებით",
        "გასწორდა პანელის გადათრევისა და დახურვის შეცდომები",
        "გაუმჯობესდა მობილური მოწყობილობის ამოცნობის სიზუსტე",
        "მობილური მთავარი გვერდის UX-ის დახვეწა და გადახვევის მინიშნებები"
      ]
    },
    "1.1.0": {
      "date": "2026-02-26",
      "changes": [
        "CSS/JS-ის მოდულური რეფაქტორინგი მარტივი მხარდაჭერისთვის",
        "მობილური მთავარი გვერდი ფუნქციების ჩვენებით",
        "მობილურისა და კომპიუტერის ზუსტი ამოცნობა",
        "სამუშაო ფურცლის ადაპტიური ზღვარი 840px-ზე დარეგულირდა",
        "სავალენტო ელექტრონების შრიფტის ზომა ადაპტიური გახდა",
        "იონის ფორმულის ჩვენების შესწორება (CH₃COO⁻) და სტილი",
        "ხელსაწყოების ფანჯრების სტილი გაერთიანდა ელემენტებისა და იონების ფანჯრებთან"
      ]
    },
    "1.0.0": {
      "date": "2026-02-07",
      "changes": [
        "ოფიციალური v1.0 გამოშვება — Zperiod საჯარო ხდება",
        "118 ელემენტი სრული ქიმიური მონაცემებით",
        "3D ატომის მოდელები ინტერაქტიული ელექტრონული ორბიტებით",
        "იონების ძრავა 50+ გავრცელებული იონით",
        "ქიმიის ხელსაწყოები: განტოლებების გამთანაბრებელი, მოლური მასა, ემპირიული ფორმულა, ხსნადობის ცხრილი",
        "სამუშაო ფურცლის გენერატორი PDF ექსპორტით",
        "Google Analytics-ისა და Microsoft Clarity-ის ინტეგრაცია",
        "საკუთარი დომენი (zperiod.app) დაკონფიგურირდა"
      ]
    },
    "0.5.0": {
      "date": "2026-01-14",
      "changes": [
        "იონების ცხრილზე სწრაფი წვდომა და ხსნადობის შემმოწმებელი",
        "ინტერფეისის მნიშვნელოვანი გაუმჯობესებები",
        "სრული README დოკუმენტაცია"
      ]
    },
    "0.1.0": {
      "date": "2025-12-29",
      "changes": [
        "საწყისი commit — ინტერაქტიული პერიოდული ცხრილის პროტოტიპი",
        "WebGL-ის თავსებადობის შესწორება სხვადასხვა მოწყობილობაზე რენდერისთვის",
        "გადასრიალებით/გადათრევით ნავიგაცია გვერდებს შორის",
        "რესურსების მინიფიკაცია და ობფუსკაციის პროცესი"
      ]
    }
  }
};
